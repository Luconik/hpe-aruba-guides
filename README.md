...
| [`copilot-studio-mcp-agent/`](https://github.com/Luconik/hpe-aruba-guides/blob/main/copilot-studio-mcp-agent) | Agents Copilot Studio pour Aruba/HPE Networking : MCP, knowledge, presales et intégrations métier | ✅ |
---
...
| [`central-nac-intune/`](central-nac-intune/) | Aruba Central NAC + Microsoft Intune — 802.1X EAP-TLS / SCEP | ✅ |
| [`copilot-studio-mcp-agent/`](https://github.com/Luconik/hpe-aruba-guides/blob/main/copilot-studio-mcp-agent) | Copilot Studio agents for Aruba/HPE Networking: MCP, knowledge, presales and business integrations | ✅ |
---
